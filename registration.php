...
<a href="">About Us</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <form action="registrationValidation.php" method="post" novalidate>
    <table>
      ...
      <td>
          ...
          <table>
            <tr>
              <td>
                ...
                <b> Confirm Password:</b> <input type="password" name="confirmPassword" id="confirmPassword"
                ...
                <b> Security Question:</b> <input type="text" name="securityQuestion" id="securityQuestion"
        ...
        <button ><a id="login_button" href="login.php">Login</a></button>
</body>
<hr>
<footer>
